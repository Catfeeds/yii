...
class WarehouseSale extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'sn', 'warehouse_id',  'create_time', 'config_id', 'sale_check_id'], 'required'],
            [['total_amount'], 'number'],
            [['department_id', 'warehouse_id', 'create_admin_id', 'verify_admin_id', 'approval_admin_id', 'operation_admin_id', 'status', 'config_id', 'timing_type', 'sale_check_id'], 'integer'],
