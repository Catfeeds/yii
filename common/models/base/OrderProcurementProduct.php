 ...
 */
class OrderProcurementProduct extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'orderprocurementproduct';
    }
    ...
    {
        return [
            [['product_id', 'order_procurement_id', 'name', 'product_number', 'supplier_id', 'supplier_product_id', 'num', 'material_type'], 'required'],
            [['product_id', 'order_procurement_id', 'product_number', 'supplier_id', 'supplier_product_id', 'status', 'material_type'], 'integer'],
