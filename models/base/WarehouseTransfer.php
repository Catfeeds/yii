 ...
 */
class WarehouseTransfer extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['name', 'sn', 'operation_admin_id', 'operation_time', 'create_time', 'config_id', 'warehouse_id', 'receive_warehouse_id', 'remark'], 'required', "message" => "{attribute}不能为空"],
            [['total_amount'], 'number'],
            [['department_id', 'warehouse_id', 'receive_warehouse_id', 'create_admin_id', 'verify_admin_id', 'approval_admin_id', 'operation_admin_id', 'status', 'config_id', 'is_buckle', 'timing_type'], 'integer'],
