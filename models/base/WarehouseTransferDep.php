...
class WarehouseTransferDep extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'sn', 'receive_warehouse_id', 'operation_admin_id', 'operation_time', 'create_time', 'config_id'], 'required', 'message' => '{attribute}不能为空'],
            [['warehouse_id', 'receive_warehouse_id', 'department_id', 'create_admin_id', 'verify_admin_id', 'approval_admin_id', 'operation_admin_id', 'status', 'config_id', 'is_buckle', 'timing_type'], 'integer'],
