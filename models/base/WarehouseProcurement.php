 ...
 */
class WarehouseProcurement extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['name', 'procurement_planning_id', 'sn', 'order_sn', 'department_id', 'planning_date', 'operation_admin_id', 'create_time', 'config_id', 'type'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'name' => 'Name',
            'procurement_planning_id' => 'Procurement Planning ID',
            'sn' => 'Sn',
            'order_sn' => 'Order Sn',
