    ...
    public function addWastage($post)
    {
        ...
        try{
            ...
            foreach ($post["stockId"] as $key => $stockId) {
                ...
                $wastageProduct->purchase_price = $stockItem->type == WarehousePlanning::TYPE_EXCEPTION ? $productItem->price : $productItem->purchase_price;
                ...
                $wastageProduct->total_amount = $wastageProduct->sale_price * $wastageProduct->buying_number;
