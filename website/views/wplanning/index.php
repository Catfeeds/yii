...
$this->title = '业务操作-物料采购计划列表';
?>
<?= $this->context->renderPartial('/public/menu') ?>
<div class="main-container">
    <div class="filter">
        <form method="get">
            <input type="hidden" name="r" value="wplanning/index" />
            <span>计划名称
            ...
            <span>付款方式
                <?= Html::dropDownList('payment', Yii::$app->request->get('payment'), $model::getPaymentSelectData(), ['prompt' => '请选择', 'class' => 'form-select']) ?>
            </span>
            <span>状态
    ...
    <table id="table-list" class="table-list">
        ...
        <?php } } else { ?>
        <tr><td colspan="16">暂无符合条件的物料采购计划记录</td></tr>
        <?php } ?>
    </table>
    <?= LinkPager::widget([
    ...
    <div class="buttons">
        <a class="button blue-button"  href="<?= Url::to(['wplanning/add']) ?>">新增采购计划</a>
        <a class="button blue-button"  href="<?= Url::to(['ordertemplate/index']) ?>">新增例行订单</a>
        <a class="button blue-button"  href="<?= Url::to(['wplanning/addexception']) ?>">新增例外订单</a>
