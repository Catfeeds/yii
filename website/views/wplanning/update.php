...
<div class="main-container">
    ...
    <table id="table-list" class="table-list taleft">
        ...
        <tr id="quick-form">
            ...
            <td style="width: 30%">采购单号：<?= Html::activeTextInput($model, 'sn', ['style' => 'width:60%',"onkeyup" => "javascript:validateValue(this)", 'class' => 'verifySpecial']) ?></td>
            <td style="width: 20%">金额：<span class="totalMoney"><?= $model->total_money;?></span><?= Html::activeHiddenInput($model, "type")?></td>
        </tr>
        <tr id="quick-form">
