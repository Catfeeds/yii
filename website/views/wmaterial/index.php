...
$departmentId = 0;
$this->title = '业务操作-物料退货列表';
?>
<?= $this->context->renderPartial('/public/menu') ?>
<div class="main-container">
    <div class="filter">
        <form method="get">
            <input type="hidden" name="r" value="wmaterial/index" />
            <span>退货名称
    ...
    <table id="table-list" class="table-list">
        ...
        <?php } } else { ?>
        <tr><td colspan="14">暂无符合条件的物料退货记录</td></tr>
        <?php } ?>
    </table>
    <?= LinkPager::widget([
    ...
    <div class="buttons">
        <a class="button blue-button" href="<?= Url::to(['wmaterial/add']) ?>">退货申请</a>
    </div>
    <?php ActiveForm::end(); ?>
</div>
