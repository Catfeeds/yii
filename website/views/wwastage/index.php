...
$departmentId = 0;
$this->title = '业务操作-物料耗损列表';
?>
<?= $this->context->renderPartial('/public/menu') ?>
<div class="main-container">
    <div class="filter">
        <form method="get">
            <input type="hidden" name="r" value="wwastage/index" />
            <span>耗损名称
    ...
    <table id="table-list" class="table-list">
        ...
        <?php } } else { ?>
        <tr><td colspan="13">暂无符合条件的物料耗损记录</td></tr>
        <?php } ?>
    </table>
    <?= LinkPager::widget([
    ...
    <?php ActiveForm::end(); ?>
    <div class="buttons">
        <a class="button blue-button" href="<?= Url::to(['pstock/wastage']) ?>">耗损申请</a>
    </div>
</div>
