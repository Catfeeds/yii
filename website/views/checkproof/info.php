...
$nextStep = Flow::showNextStepByInfo(Flow::TYPE_CHECK_PLANNING_PROOF, $model, 'operator_url');
$remarkList = CommonRemark::getRemarkList($model->id, Flow::TYPE_CHECK_PLANNING_PROOF);
?>
...
<div class="main-container">
    <div class="filter">
        <table id="table-list" class="table-list taleft">
            ...
            <tr>
                <td style="width: 50%;">校对表单名：<?= $model->name ?></td>
                <td style="width: 25%;">状态：<?= Flow::showStatusAll($model->status) ?></td>
            ...
            <tr>
                ...
                <td colspan="2">盘点后总金额：<?= $model->check_buying_amount ?></td>
            </tr>
            <tr>
