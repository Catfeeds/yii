...
$departmentId = 0;
$this->title = '业务操作-物料转货列表';
?>
<?= $this->context->renderPartial('/public/menu') ?>
<div class="main-container">
    <div class="filter">
        <form method="get">
            <input type="hidden" name="r" value="wtransferdep/index" />
            <span>转货名称
    ...
    <table id="table-list" class="table-list">
        ...
        <?php } } else { ?>
        <tr><td colspan="14">暂无符合条件的物料转货记录</td></tr>
        <?php } ?>
    </table>
    <?= LinkPager::widget([
    ...
    <?php ActiveForm::end(); ?>
    <div class="buttons">
        <a class="button blue-button" href="<?= Url::to(['pstock/transferdep']) ?>">转货申请</a>
    </div>
</div>
