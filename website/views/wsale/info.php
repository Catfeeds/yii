...
$nextStep = Flow::showNextStepByInfo(Flow::TYPE_SALE, $model, 'operator_url');
$remarkList = CommonRemark::getRemarkList($model->id, Flow::TYPE_SALE);
?>
    ...
    <div class="filter">
        <table id="table-list" class="table-list taleft">
            ...
            <tr id="quick-form">
                ...
                <td width="20%">销存总价：<?= number_format($model->total_amount, 2) ?></td>
