...
$nextStep = Flow::showNextStepByInfo(Flow::TYPE_CHECK_DEPARTMENT, $model, 'operator_url');
$remarkList = CommonRemark::getRemarkList($model->id, Flow::TYPE_CHECK_DEPARTMENT);
?>
...
<div class="main-container">
    <div class="filter">
        <table id="table-list" class="table-list taleft">
            ...
            <tr>
                ...
                <td>盘点部门：<?= Department::getNameById($model->department_id) ?></td>
                <td colspan="2">是否盘点资金：<?= $model->is_check_amount ? "是" : "否" ?></td>
            </tr>
            <tr>
    ...
    <div class="buttons">
        ...
        <?php if($model->status == Flow::STATUS_FINISH && !$model->is_proof){ ?>
            <a class="button blue-button" href="<?= Url::to(['departmentcheckplanning/proof',"id" => $model->id]) ?>">盘点</a> 
         <?php } ?>
