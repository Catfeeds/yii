...
<div class="main-container">
    <div class="filter">
        <form method="get">
            <input type="hidden" name="r" value="checkplanning/index" />
            <span>计划名称
    ...
    <table id="table-list" class="table-list">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if($data->status == Flow::STATUS_FINISH && !$data->is_proof){ ?>
                           <a class="quick-form-button" href="<?= Url::to(['checkplanning/proof',"id" => $data->id]) ?>" style="margin-left: 10px;">盘点</a> 
                    <?php } else { ?>
        ...
        <?php } } else { ?>
            <tr><td colspan="12">暂无总盘点计划</td></tr>
        <?php } ?>
    </table>
    ...
    <?php ActiveForm::end(); ?>
    <?php //if(Admin::checkSupperFlowAdmin() || RoleJurisdiction::checkRoleJue('checkplanning/addorupdate')){ ?>
    <div class="buttons">
        <a class="button blue-button" href="<?= Url::to(['checkplanning/addorupdate']) ?>">新增</a>
