...
$departmentId = 0;
$this->title = '业务操作-物料出库列表';
?>
<?= $this->context->renderPartial('/public/menu') ?>
<div class="main-container">
    <div class="filter">
        <form method="get">
            <input type="hidden" name="r" value="wcheckout/index" />
            <span>出库名称
            ...
            <span>入库仓库
                <?= Html::dropDownList('receive_warehouse_id', Yii::$app->request->get('receive_warehouse_id'), Warehouse::getAllByStatus(Warehouse::STATUS_OK, Warehouse::SALE_YES,$departmentId), ['prompt' => '请选择', 'class' => 'form-select']) ?>
            </span>
            <span>状态
    ...
    <table id="table-list" class="table-list">
        ...
        <?php } } else { ?>
        <tr><td colspan="13">暂无符合条件的物料出库记录</td></tr>
        <?php } ?>
    </table>
    <?= LinkPager::widget([
    ...
    <?php ActiveForm::end(); ?>
    <div class="buttons">
        <a class="button blue-button" href="<?= Url::to(['pstock/checkout']) ?>">出库申请</a>
        <a class="button blue-button" href="<?= Url::to(['combination/index']) ?>">生成例行出库</a>
