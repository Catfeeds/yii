 ...
 * 业务操作 -- 库存管理 -- 退仓管理
 */
class WbackController extends CController
{
    /**
     * 退仓列表页
     */
...
//        }
    ...
    {
        $model = WarehouseBack::findOne($id);
        $info = WarehouseBackProduct::findAll(["back_id" => $id]);
    ...
    public function actionVerify($id) 
    {
        ...
        $result = Flow::Verify(Flow::TYPE_BACK, $model, $remark);
    ...
    public function actionApproval($id)
    {
        $model = WarehouseBack::findOne($id);
        $remark = Yii::$app->request->get('remark');
        $result = Flow::Approval(Flow::TYPE_BACK, $model, $remark);
        return Json::encode($result);
    }
    /**
     * 完成操作
    ...
    public function actionFinish($id)
    {
        $model = WarehouseBack::findOne($id);
        $remark = Yii::$app->request->get('remark');
        $result = Flow::Finish(Flow::TYPE_BACK, $model, $remark);
        return Json::encode($result);
    }
    /**
     * 驳回操作
    ...
    public function actionReject()
    {
        ...
        $model = WarehouseBack::findOne($id);
        $result = Flow::Reject(Flow::TYPE_BACK, $model, $failCause);
        return Json::encode($result);
    }
}
